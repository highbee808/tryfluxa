...
const Feed = () => {
  ...
  const [chatContext, setChatContext] = useState<
    { topic: string; summary: string; requestId?: string } | undefined
  >(undefined);
                ...
                if (entity.news_feed && Array.isArray(entity.news_feed)) {
                  entity.news_feed.slice(0, 3).forEach((news: any, idx: number) => {
                    allNews.push({
                      ...
                      description:
                        news.description || `Latest news about ${entity.name}`,
                      url: news.url,
      ...
      <div className="sticky top-0 z-50 px-4 pt-4 pb-3 bg-background/85 backdrop-blur-xl border-b border-glass-border-light">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="start"
              className="w-56 glass border-glass-border-light rounded-2xl"
            >
              <DropdownMenuItem
